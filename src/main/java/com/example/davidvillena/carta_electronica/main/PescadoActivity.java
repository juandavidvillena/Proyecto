...
import com.example.davidvillena.carta_electronica.adapter.RecyclerAdapterPescado;
...
public class PescadoActivity extends AppCompatActivity {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    ArrayList<Plato> listaPlatos;
    RecyclerAdapterPescado adapter;
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pescado);CollapsingToolbarLayout ctl = findViewById(R.id.toolbar_layout);
        listaPlatos = new ArrayList<>();
        setUpRecyclerView();
        ctl.setTitle("Pescado");
        ...
        db.collection("Pescado")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter = new RecyclerAdapterPescado(listaPlatos, PescadoActivity.this);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PescadoActivity.this, "No se pudo cargar los datos", Toast.LENGTH_LONG).show();
            }
        });
    }
