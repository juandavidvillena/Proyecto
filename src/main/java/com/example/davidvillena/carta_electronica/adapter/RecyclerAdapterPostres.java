...
public class RecyclerAdapterPostres extends RecyclerView.Adapter<RecyclerAdapterPostres.RecyclerViewHolder> {
    private static int pos;

    ArrayList<Plato> listaPlatos;
    PostresActivity postresActivity;


    public RecyclerAdapterPostres(ArrayList<Plato> listaPlatos, PostresActivity postresActivity) {
        this.listaPlatos = listaPlatos;
        this.postresActivity = postresActivity;
    }
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LayoutInflater layoutInflater =  LayoutInflater.from(postresActivity.getBaseContext());
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder recyclerViewHolder, int i) {
        ...
        recyclerViewHolder.foto.setImageResource(R.drawable.postre);
    }
    @Override
